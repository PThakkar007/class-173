...
AFRAME.registerComponent("markerhandler", {
  ...
  handleRatings: async function (dish) {
    ...
    var saverattingbutton=document.getElementById("save-rating-button")
    saverattingbutton.addEventListener("click",()=>{
    ...
    swal({
      icon:"warning",
      title:"oops!!!",
      text:"Sorry no dish found for your given ratings",
      timer:2500,
      buttons:false
